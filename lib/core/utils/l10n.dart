...
class L10n {
  ...
  static const _localizedValues = {
    'vi': {
      ...
      'delete_notification': 'Xoá thông báo này',
      'budget_threshold_title': '⚠️ Hạn mức {name}',
      'budget_threshold_body': 'Bạn đã sử dụng {percent}% ngân sách của danh mục <b>{name}</b>',
      'budget_exceeded_title': '🚨 Vượt hạn mức',
      'budget_exceeded_body': 'Bạn đã chi tiêu vượt quá ngân sách của danh mục <b>{name}</b>',
      'savings_halfway_title': 'Tiến trình tích luỹ',
      'savings_halfway_body': 'Bạn đã hoàn thành {percent}% mục tiêu tích luỹ <b>{name}</b>',
      'savings_completed_title': '🌟 Thành công',
    ...
    'en': {
      ...
      'budget_threshold_body': 'You have used {percent}% of the budget for category <b>{name}</b>',
      'budget_exceeded_title': '🚨 Over Budget',
      'budget_exceeded_body': 'You have exceeded the budget for category <b>{name}</b>',
      'savings_halfway_title': 'Savings Goal Progress',
      'savings_halfway_body': 'You have completed {percent}% of the savings goal <b>{name}</b>',
      'savings_completed_title': '🌟 Success',
