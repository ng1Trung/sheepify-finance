...
class L10n {
  ...
  static const _localizedValues = {
    'vi': {
      ...
      'budget_threshold_title': '⚠️ Hạn mức {name}',
      'budget_threshold_body': 'Bạn đã tiêu hết {percent}% ngân sách cho mục này rồi. Cân đối lại một chút nhé!',
      'budget_exceeded_title': '🚨 Vượt hạn mức!',
      'budget_exceeded_body': 'Chi tiêu cho {name} đã chạm ngưỡng/vượt quá ngân sách đề ra. Hãy chú ý hơn trong các ngày tới!',
      'savings_halfway_title': '🎉 Đi được nửa chặng đường rồi!',
      'savings_halfway_body': 'Mục tiêu tích lũy {name} đã hoàn thành 50%. Cố lên nào!',
      'savings_completed_title': '🌟 Thành công rực rỡ!',
      'savings_completed_body': 'Bạn đã hoàn thành xuất sắc mục tiêu {name}. Bấm vào đây để xem lại hành trình của bạn!',
    ...
    'en': {
      ...
      'error_select_category': 'Please choose a category!',
      ...
      'clear_all': 'Clear all',
      'budget_threshold_title': '⚠️ Budget Limit: {name}',
      'budget_threshold_body': 'You have spent {percent}% of the budget for this item. Balance it a bit!',
      'budget_exceeded_title': '🚨 Over Budget!',
      'budget_exceeded_body': 'Spending for {name} has reached or exceeded the budget. Be more careful in the next days!',
      'savings_halfway_title': '🎉 Halfway there!',
      'savings_halfway_body': 'Savings goal {name} is 50% complete. Keep going!',
      'savings_completed_title': '🌟 Brilliant Success!',
      'savings_completed_body': 'You have outstandingly completed the savings goal {name}. Click here to review your journey!',
